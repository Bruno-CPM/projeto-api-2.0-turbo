...
import br.com.criandoAPI.projeto.infra.security.DadosTokenJWT;
...
public class AutenticacaoController {
    ...
    @PostMapping("/login")
    public ResponseEntity<DadosTokenJWT> logarUsuario(@RequestBody @Valid DadosAutenticacao dados) {
